...
/// </summary>
public interface IChatStorageContext<T> where T : IChatStorageEntity
{
    /// <summary>
...
/// </summary>
public interface ICopilotChatMessageStorageContext : IChatStorageContext<CopilotChatMessage>
{
    /// <summary>
    /// Query entities in the storage context.
    /// </summary>
