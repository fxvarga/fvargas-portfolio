...
/// </summary>
public class ChatRepository<T> : IChatRepository<T> where T : IChatStorageEntity
{
    /// <summary>
    /// The storage context.
    /// </summary>
    protected IChatStorageContext<T> StorageContext { get; set; }

    /// <summary>
    /// Initializes a new instance of the Repository class.
    /// </summary>
    public ChatRepository(IChatStorageContext<T> storageContext)
    {
...
/// </summary>
public class CopilotChatMessageRepository : ChatRepository<CopilotChatMessage>
{
