...
/// </summary>
public class ChatParticipantRepository : ChatRepository<ChatParticipant>
{
    /// <summary>
    /// Initializes a new instance of the ChatParticipantRepository class.
    /// </summary>
    /// <param name="storageContext">The storage context.</param>
    public ChatParticipantRepository(IChatStorageContext<ChatParticipant> storageContext)
        : base(storageContext)
    {
    }
