...
namespace FV.Infrastructure.Extensions;
public static class KernelMemoryClientExtensions
{
    ...
    public static IServiceCollection AddKernelMemoryServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // services.AddSingleton(sp => new DocumentTypeProvider(hasOcr));
    ...
    {
        return new KernelMemoryServiceConfigurator(servicesConfiguration, memoryConfiguration).PrepareBuilder(builder);
    }
    // Copyright (c) Microsoft. All rights reserved.
}
public sealed class KernelMemoryServiceConfigurator
{
    ...
    public KernelMemoryServiceConfigurator(
    ...
    private void ConfigureIngestionEmbeddingGenerators(IKernelMemoryBuilder builder)
    {
        ...
        var azureOpenAiConfig = this.GetServiceConfig<AzureOpenAIConfig>("AzureOpenAIEmbedding");
        TokenCredential aiCredential = new DefaultAzureCredential();
        azureOpenAiConfig.SetCredential(aiCredential);
    ...
    {
        var azureOpenAiConfig = this.GetServiceConfig<AzureOpenAIConfig>("AzureOpenAIText");
        // Text generation
        TokenCredential aiCredential = new DefaultAzureCredential();
        azureOpenAiConfig.SetCredential(aiCredential);
