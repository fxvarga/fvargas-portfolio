...
const steps = [
  {
    number: '01',
    title: 'Analyze',
    description: 'We audit your current operations, interview your team, and map every process that touches manual work — finding the bottlenecks that cost you the most time.',
    icon: (
  ...
  },
  {
    number: '02',
    title: 'Design',
    description: 'We architect the automated workflows, select the right tools (n8n, Zapier, custom APIs), and create a detailed implementation plan with clear ROI projections.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    number: '03',
    title: 'Implement',
    description: 'We build, test, and deploy the automations, then train your team and provide 30 days of support to ensure everything runs flawlessly.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
