...
// to Brad's portfolio app's config and auth system.
//
...
/**
 * Known CMS-driven sections in Brad's portfolio.
 * Maps CSS selectors to CMS entity types for inline editing.
 */
const PORTFOLIO_SECTIONS: SectionDescriptor[] = [
  { selector: 'header',               entityType: 'navigation',  label: 'Navigation' },
  { selector: '#home',                entityType: 'hero',        label: 'Hero Section' },
  { selector: '#about',               entityType: 'about',       label: 'About Section' },
  { selector: '#resume',              entityType: 'resume',      label: 'Resume Section' },
  { selector: '#services',            entityType: 'services',    label: 'Services Section' },
  { selector: '#portfolio',           entityType: 'portfolio',   label: 'Portfolio Section' },
  { selector: '#contact',             entityType: 'contact',     label: 'Contact Section' },
  { selector: '#blog',                entityType: 'blog-post',   label: 'Blog Section' },
...
/**
 * Wrapper that bridges Brad's portfolio auth and content state
